...
public class NewActivity extends Activity implements AdapterView.OnItemSelectedListener{
    //Variable is making unique identifiers for incident's shift entries
    int id = 1;
    ...
    //The input text fields that contain the total shift cost and hours
    EditText result;
    EditText hours;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NameOfActivity.setText("New Incident");
        ...
        //Variables used for accessing the elements in the app
        ...
        //Gets the total shift cost when the result button is clicked
        ...
        resultButton.setOnClickListener(new OnClickListener(){
            public void onClick(View view) {
                ...
                //If the user leaves the on/off fields empty or enters 0 set the int values to 0 to prevent the app from closing due to an error
                ...
                if(TextUtils.isEmpty(textVal) || textVal.equals("0")){
                    ...
                    num1 = getCorrectValueHours(textVal);
                }
                if(TextUtils.isEmpty(textVal2) || textVal2.equals("0")){
                    num2 = 0;
                }
                else{
                    num2 = getCorrectValueHours(textVal2);
                }
                ...
                if(TextUtils.isEmpty(textVal3) || textVal3.equals("0")){
                    ...
                    num3 = getCorrectValueHours(textVal3);
                }
                ...
                if(TextUtils.isEmpty(textVal4) || textVal4.equals("0")){
                    ...
                    num4 = getCorrectValueHours(textVal4);
                }
        ...
        storeButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //Gets a JSON obj containing the Incident's name, fire #, total hrs, total cost, and shift entries
...
// TODO Auto-generated method stub
    ...
    public int getCorrectValueHours(String numberText){
    ...
    public void layoutAddResult(String cost, String hours, String dateString){
        ...
        //Sets an identifier for the TableLayout for a shift entry for deleting purposes
        tl.setTag("tl" + id);
        ...
        deleteButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //When the shift entry is deleted the total hrs and total cost for the incident are recalculated
                CalcInvoice();
            }
        });
   ...
   public void CalcInvoice(){
    ...
    public JSONObject MakeJSON() {
        ...
        try {
            //Stores the name, total cost, total hours, and fire number into the JSON obj
            ...
            //If there are shift entries it creates an array of JSON object entries and stores the array in Incident JSON obj
            TableLayout tlContent = (TableLayout) findViewById(R.id.resultContent);
            if (tlContent.getChildCount() != 0) {
                ...
                do {
                    ...
                    try{
                        ...
                        //Adds the JSON Entry obj to the Entries JSON array
                        Entries.put(Entry);
                    }
